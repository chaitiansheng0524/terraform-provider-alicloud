		...
		Steps: []resource.TestStep{
			{
				Config: testAccConfig(map[string]interface{}{
					...
					"instance_type":         "mysqlro.n2m.medium.1c",
			...
			},
			{
				...
				ImportStateVerifyIgnore: []string{"force_restart", "effective_time", "parameters"},
			},
			...
			{
				Config: testAccConfig(map[string]interface{}{
					"instance_type": "mysqlro.n4m.medium.1c",
				}),
				Check: resource.ComposeTestCheckFunc(
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportState:             true,
				ImportStateVerify:       true,
				ImportStateVerifyIgnore: []string{"force_restart", "ssl_enabled", "server_cert", "server_key", "parameters"},
			},
